...
export default {
  ...
  head: {
    ...
    meta: [
      ...
      { hid: 'description', name: 'description', content: 'cashの変更をテストをしているページです。' },
      { property: 'og:title', content: 'cashの変更テストページ' },
      { property: 'og:description', content: 'cashの変更をテストをしているページです。' },
      ...
      { property: 'twitter:title', content: 'cashの変更テストページ' },
      { property: 'twitter:description', content: 'cashの変更をテストをしているページです。' },
